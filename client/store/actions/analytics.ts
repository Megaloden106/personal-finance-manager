...
export const analyticsTotalAction = (id: string) => createAction(REQUEST_ANALYTICS_TOTAL, id);
...
export const analyticsAnnualizeAction = (id: string) => createAction(
...
export const analyticsPastYearAction = (id: string) => createAction(
